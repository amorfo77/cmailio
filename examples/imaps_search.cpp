...
int main()
{
    try
    {
        ...
        conn.authenticate("cmailio@outlook.com", "cmailiopass", imaps::auth_method_t::LOGIN);
        ...
        conds.push_back(imaps::search_condition_t(imaps::search_condition_t::SUBJECT, "cmailio"));
