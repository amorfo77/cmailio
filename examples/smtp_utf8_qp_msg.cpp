...
int main()
{
    try
    {
        ...
        msg.from(mail_address("cmailio library", "cmailio@mailserver.com"));// set the correct sender name and address
        msg.add_recipient(mail_address("cmailio library", "cmailio@gmail.com"));// set the correct recipent name and address
        msg.add_recipient(mail_address("cmailio library", "cmailio@outlook.com"));// add more recipients
        msg.add_cc_recipient(mail_address("cmailio library", "cmailio@yahoo.com"));// add CC recipient
        msg.add_bcc_recipient(mail_address("cmailio library", "cmailio@zoho.com"));
        ...
        msg.content(
            ...
            u8"основу тога дорадити форматирање мејла. А можда и нема потребе, јер libcmailio није замишљен да се\r\n"
        ...
        conn.authenticate("cmailio@mailserver.com", "cmailiopass", smtp::auth_method_t::LOGIN);
        conn.submit(msg);
    }
