...
#include <ccmailio/mailboxes.hpp>
#include <ccmailio/message.hpp>
...
using ccmailio::string_t;
using ccmailio::codec;
using ccmailio::mail_address;
using ccmailio::mail_group;
using ccmailio::mime;
using ccmailio::message;
using ccmailio::mime_error;
using ccmailio::message_error;
using ccmailio::codec_error;
...
{
    message msg;
    msg.from(mail_address("ccmailio", "adresa@ccmailio.dev"));
    msg.reply_address(mail_address("Tomislav Karastojkovic", "kontakt@ccmailio.dev"));
    msg.add_recipient(mail_address("kontakt", "kontakt@ccmailio.dev"));
    msg.add_recipient(mail_address("ccmailio", "adresa@ccmailio.dev"));
    msg.add_recipient(mail_group("all", {mail_address("Tomislav", "qwertyuiop@hotmail.com")}));
    msg.add_cc_recipient(mail_group("ccmailio", {mail_address("", "karas@ccmailio.dev"), mail_address("Tomislav Karastojkovic", "kontakt@ccmailio.dev")}));
    msg.add_cc_recipient(mail_address("Tomislav Karastojkovic", "kontakt@ccmailio.dev"));
    msg.add_cc_recipient(mail_address("Tomislav @ Karastojkovic", "qwertyuiop@gmail.com"));
    msg.add_cc_recipient(mail_address("ccmailio", "adresa@ccmailio.dev"));
    ...
    msg.add_bcc_recipient(mail_address("Tomislav Karastojkovic", "kontakt@ccmailio.dev"));
    msg.add_bcc_recipient(mail_address("Tomislav @ Karastojkovic", "qwertyuiop@gmail.com"));
    msg.add_bcc_recipient(mail_address("ccmailio", "adresa@ccmailio.dev"));
    ...
    BOOST_CHECK(msg.from_to_string() == "ccmailio <adresa@ccmailio.dev>");
    BOOST_CHECK(msg.reply_address_to_string() == "Tomislav Karastojkovic <kontakt@ccmailio.dev>");
    BOOST_CHECK(msg.recipients_to_string() == "kontakt <kontakt@ccmailio.dev>,\r\n"
        "  ccmailio <adresa@ccmailio.dev>,\r\n"
        "  all: Tomislav <qwertyuiop@hotmail.com>;");
    BOOST_CHECK(msg.cc_recipients_to_string() == "Tomislav Karastojkovic <kontakt@ccmailio.dev>,\r\n"
        "  \"Tomislav @ Karastojkovic\" <qwertyuiop@gmail.com>,\r\n"
        "  ccmailio <adresa@ccmailio.dev>,\r\n"
        "  ccmailio: <karas@ccmailio.dev>,\r\n"
        "  Tomislav Karastojkovic <kontakt@cmailio.dev>;\r\n"
        "  all: <qwertyuiop@hotmail.com>,\r\n"
        "  Tomislav <qwertyuiop@gmail.com>,\r\n"
        "  \"Tomislav @ Karastojkovic\" <qwertyuiop@zoho.com>;");
    BOOST_CHECK(msg.bcc_recipients_to_string() == "Tomislav Karastojkovic <kontakt@cmailio.dev>,\r\n"
        "  \"Tomislav @ Karastojkovic\" <qwertyuiop@gmail.com>,\r\n"
        "  cmailio <adresa@cmailio.dev>");
...
{
    message msg;
    msg.sender(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
...
{
    message msg;
    msg.add_from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.add_from(mail_address("karas", "karas@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
...
{
    message msg;
    msg.from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.subject("Hello, World!");
    msg.content("Hello, World!");
    ptime t = time_from_string("2014-01-17 13:09:22");
    ...
    local_date_time ldt(t, tz);
    msg.date_time(ldt);
    msg.add_header("User-Agent", "cmailio");
    ...
    BOOST_CHECK(msg_str == "Content-Language: en-US\r\n"
        "User-Agent: cmailio\r\n"
        "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
...
BOOST_AUTO_TEST_CASE(format_long_text_default_default)
{
    ...
    msg.content("Ovo je jako dugachka poruka koja ima i praznih linija i predugachkih linija. Nije jasno kako ce se tekst prelomiti\r\n"
        ...
        "osnovu toga doraditi formatiranje sadrzzaja mejla. A mozzda i nema potrebe, jer libcmailio nije zamishljen da se\r\n"
    ...
    BOOST_CHECK(msg_str ==
        ...
        "r libcmailio nije zamishljen da se\r\n"
        "bavi formatiranjem teksta.\r\n"
        "\r\n\r\n"
...
BOOST_AUTO_TEST_CASE(format_long_text_ascii_qp)
{
    ...
    BOOST_CHECK(msg_str ==
        ...
        "jer libcmailio nije zamishljen da se\r\n"
        "bavi formatiranjem teksta.\r\n\r\n\r\n"
...
BOOST_AUTO_TEST_CASE(format_long_text_utf8_base64)
{
    ...
    msg.content("Ово је јако дугачка порука која има и празних линија и предугачких линија. Није јасно како ће се текст преломити\r\n"
        ...
        "основу тога дорадити форматирање мејла. А можда и нема потребе, јер libcmailio није замишљен да се\r\n"
...
BOOST_AUTO_TEST_CASE(format_long_text_utf8_cyr_qp)
{
    ...
    BOOST_CHECK(msg_str ==
        ...
        "=82=D1=80=D0=B5=D0=B1=D0=B5, =D1=98=D0=B5=D1=80 libcmailio =D0=BD=D0=B8=D1=\r\n"
...
BOOST_AUTO_TEST_CASE(format_long_text_utf8_lat_qp)
{
    ...
    msg.content("Ovo je jako dugačka poruka koja ima i praznih linija i predugačkih linija. Nije jasno kako će se tekst prelomiti\r\n"
        ...
        "\r\n"
        "Treba videti kako poznati mejl klijenti lome tekst, pa na\r\n"
        "osnovu toga doraditi formatiranje sadržaja mejla. A možda i nema potrebe, jer libcmailio nije zamišljen da se\r\n"
        "bavi formatiranjem teksta.\r\n"
        "\r\n\r\n"
    ...
    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Date: Fri, 17 Jan 2014 05:39:22 -0730\r\n"
        "Content-Type: text/plain; charset=utf-8\r\n"
        "Content-Transfer-Encoding: Quoted-Printable\r\n"
        ...
        "potrebe, jer libcmailio nije zami=C5=A1ljen da se\r\n"
        "bavi formatiranjem teksta.\r\n"
        "\r\n"
        "\r\n"
...
BOOST_AUTO_TEST_CASE(format_multipart_html_ascii_bit7_text_ascii_base64)
{
    message msg;
    msg.from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.reply_address(mail_address("Tomislav Karastojkovic", "adresa@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    ptime t = time_from_string("2014-01-17 13:09:22");
    time_zone_ptr tz(new posix_time_zone("-07:30"));
    local_date_time ldt(t, tz);
    ...
    BOOST_CHECK(msg_str ==
        "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Date: Fri, 17 Jan 2014 05:39:22 -0730\r\n"
        "MIME-Version: 1.0\r\n"
...
BOOST_AUTO_TEST_CASE(format_multipart_content)
{
    ...
    msg.date_time(ldt);
    msg.from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.reply_address(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    ...
    BOOST_CHECK(msg_str ==
        "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
...
BOOST_AUTO_TEST_CASE(format_notification)
{
    ...
    msg.from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.disposition_notification(mail_address("cmailio", "adresa@cmailio.dev"));
    ptime t = time_from_string("2016-02-11 22:56:22");
    time_zone_ptr tz(new posix_time_zone("+00:00"));
    local_date_time ldt(t, tz);
    msg.date_time(ldt);
    ...
    BOOST_CHECK(msg_str == "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Disposition-Notification-To: cmailio <adresa@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
...
BOOST_AUTO_TEST_CASE(format_qb_sender)
{
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.header_codec(message::header_codec_t::BASE64);
    msg.from(mail_address("маилио", "adresa@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    ...
    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "From: =?UTF-8?B?0LzQsNC40LvQuNC+?= <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>,\r\n"
...
BOOST_AUTO_TEST_CASE(format_qq_sender)
{
    ...
    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "From: =?UTF-8?Q?=D0=BC=D0=B0=D0=B8=D0=BB=D0=B8=D0=BE?= <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>,\r\n"
...
BOOST_AUTO_TEST_CASE(format_message_id)
{
    ...
    msg.message_id("1234567890@cmailio.dev");

    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Message-ID: <1234567890@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: Proba\r\n"
        "\r\n"
        "Zdravo, Svete!\r\n");
...
BOOST_AUTO_TEST_CASE(format_message_id_no_monkey_strict)
{
    ...
    msg.subject("Proba");
    msg.content("Zdravo, Svete!");
    BOOST_CHECK_THROW(msg.message_id("1234567890cmailio.dev"), message_error);
}
...
BOOST_AUTO_TEST_CASE(format_message_id_no_monkey_non_strict)
{
    ...
    msg.subject("Proba");
    msg.content("Zdravo, Svete!");
    msg.message_id("1234567890cmailio.dev");

    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Message-ID: <1234567890cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: Proba\r\n"
        "\r\n"
        "Zdravo, Svete!\r\n");
...
BOOST_AUTO_TEST_CASE(format_message_id_with_space_strict)
{
    ...
    msg.subject("Proba");
    msg.content("Zdravo, Svete!");
    BOOST_CHECK_THROW(msg.message_id("1234567890@ cmailio.dev"), message_error);
}
...
BOOST_AUTO_TEST_CASE(format_in_reply_to)
{
    ...
    msg.subject("Proba");
    msg.content("Zdravo, Svete!");
    msg.add_in_reply_to("1@cmailio.dev");
    msg.add_in_reply_to("22@cmailio.dev");
    msg.add_in_reply_to("333@cmailio.dev");
    msg.add_references("4444@cmailio.dev");
    msg.add_references("55555@cmailio.dev");

    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "In-Reply-To: <1@cmailio.dev> <22@cmailio.dev> <333@cmailio.dev>\r\n"
        "References: <4444@cmailio.dev> <55555@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: Proba\r\n"
        "\r\n"
        "Zdravo, Svete!\r\n");
...
BOOST_AUTO_TEST_CASE(format_long_header)
{
    message msg;
    msg.from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg.reply_address(mail_address("Tomislav Karastojkovic", "kontakt@cmailio.dev"));
    msg.add_recipient(mail_address("contact", "kontakt@cmailio.dev"));
    msg.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    ...
    local_date_time ldt(t, tz);
    msg.date_time(ldt);
    msg.add_header("Proba", "1234567890123456789 01234567890123456789012345678901234567890123456789012345678901234567890 12345678901234567890@cmailio.dev");

    string msg_str;
    msg.format(msg_str);
    BOOST_CHECK(msg_str == "Proba: 1234567890123456789\r\n"
        "  01234567890123456789012345678901234567890123456789012345678901234567890\r\n"
        "  12345678901234567890@cmailio.dev\r\n"
        "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <kontakt@cmailio.dev>\r\n"
        "To: contact <kontakt@cmailio.dev>,\r\n"
        "  cmailio <adresa@cmailio.dev>,\r\n"
...
{
    string msg_str = "From: mail io <adre.sa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
    ...
    local_date_time ldt(t, tz);
    msg.parse(msg_str);
    BOOST_CHECK(msg.from().addresses.at(0).name == "mail io" && msg.from().addresses.at(0).address == "adre.sa@cmailio.dev" && msg.date_time() == ldt &&
        msg.recipients_to_string() == "cmailio <adresa@cmailio.dev>" && msg.subject() == "parse simple" &&
        msg.content() == "hello\r\n\r\nworld\r\n\r\n\r\nopa bato");
}
...
BOOST_AUTO_TEST_CASE(parse_custom_header)
{
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    string msg_str = "From: mail io <adre.sa@cmailio.dev>\r\n"
        "To: cmailio <adre.sa@cmailio.dev>\r\n"
        ...
        "Hello, world!\r\n";
    msg.parse(msg_str);
    BOOST_CHECK(msg.headers().size() == 2 && msg.headers().find("User-Agent")->second == "cmailio");
    msg.remove_header("User-Agent");
    BOOST_CHECK(msg.headers().size() == 1);
}
...
BOOST_AUTO_TEST_CASE(parse_line_len)
{
    message msg;
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    string msg_str = "From: adre.sa@cmailio.dev\r\n"
        "To: adre.sa@cmailio.dev\r\n"
    ...
    msg.parse(msg_str);
    BOOST_CHECK(msg.from().addresses.at(0).address == "adre.sa@cmailio.dev" && msg.content().size() == 244);
}
...
BOOST_AUTO_TEST_CASE(parse_by_line_oversized)
{
    message msg;
    msg.line_policy(codec::line_len_policy_t::RECOMMENDED, codec::line_len_policy_t::RECOMMENDED);
    msg.parse_by_line("From: cmailio <adresa@cmailio.dev>");
    msg.parse_by_line("To: cmailio");
...
BOOST_AUTO_TEST_CASE(parse_base64_line_oversized)
{
    ...
    msg.line_policy(codec::line_len_policy_t::RECOMMENDED, codec::line_len_policy_t::RECOMMENDED);
    msg.parse_by_line("From: cmailio <adresa@cmailio.dev>");
    msg.parse_by_line("To: cmailio <adresa@cmailio.dev>");
...
{
    string msg_str = "From: mail io <adresa@cmailio.dev>\r\n"
        "To: info,\r\n"
        "  kontakt@cmailio.dev,\r\n"
        "  all, \r\n"
        "  mail io <adresa@cmailio.dev>\r\n"
        "Cc: all: Tomislav <qwerty@cmailio.dev>, \r\n"
        "  \"Tomislav Karastojkovic\" <asdfgh@cmailio.dev>; \r\n"
        "  adresa@cmailio.dev,\r\n"
        "  undisclosed-recipients:;\r\n"
        "  qwerty@gmail.com,\r\n"
        "  \"Tomislav\" <qwerty@hotmail.com>,\r\n"
        "  <qwerty@zoho.com>, \r\n"
        "  cmailio: qwerty@outlook.com;\r\n"
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.from().addresses.at(0).name == "mail io" && msg.from().addresses.at(0).address == "adresa@cmailio.dev" &&
        msg.recipients().addresses.size() == 4 &&
        msg.recipients_to_string() == "info,\r\n  <kontakt@cmailio.dev>,\r\n  all,\r\n  mail io <adresa@cmailio.dev>" &&
        msg.recipients().addresses.at(0).name == "info" && msg.recipients().addresses.at(1).address == "kontakt@cmailio.dev" &&
        msg.recipients().addresses.at(2).name == "all" &&
        msg.recipients().addresses.at(3).name == "mail io" && msg.recipients().addresses.at(3).address == "adresa@cmailio.dev" &&
        msg.cc_recipients().addresses.size() == 4 && msg.cc_recipients().groups.size() == 3 &&
        msg.cc_recipients().groups.at(0).name == "all" && msg.cc_recipients().addresses.at(0).address == "adresa@cmailio.dev" &&
        ...
        msg.cc_recipients().groups.at(2).name == "cmailio" && msg.cc_recipients().groups.at(2).members.size() == 1 &&
...
{
    string msg_str = "From: cmailio adresa@cmailio.dev\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
...
{
    string msg_str = "Sender: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
...
{
    string msg_str = "From: maill.io@cmailio.dev\r\n"
        "To: <cmailio>\r\n"
...
BOOST_AUTO_TEST_CASE(parse_recommended_address)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <kontakt@cmailio.dev>\r\n"
        "To: contact <kontakt@cmailio.dev>, Tomislav Karastojkovic <karas@cmailio.dev>, Tomislav Karastojkovic <qwerty@gmail.com>, "
        "Tomislav Karastojkovic <asdfg@zoho.com>\r\n"
        "Cc: mail.io <adresa@cmailio.dev>, Tomislav Karastojkovic <zxcvb@yahoo.com>\r\n"
...
{
    string msg_str = "From: cmailio <adresa@cmailio.dev> (Mail Delivery System)\r\n"
        "To: adresa@cmailio.dev, all: qwerty@gmail.com, Karas <asdfgh@cmailio.dev>; Tomislav <qwerty@hotmail.com> (The comment)\r\n"
    ...
    BOOST_CHECK(msg.from().addresses.at(0).name == "cmailio" && msg.from().addresses.at(0).address == "adresa@cmailio.dev" &&
...
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: aaa@cmailio.dev <bbb@cmailio.dev>\r\n"
...
BOOST_AUTO_TEST_CASE(parse_double_address_non_strict)
{
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.recipients().addresses.at(0).name == "aaa@cmailio.dev" && msg.recipients().addresses.at(0).address == "bbb@cmailio.dev");
}
...
BOOST_AUTO_TEST_CASE(parse_content_type)
{
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.content_type().type == cmailio::mime::media_type_t::TEXT && msg.content_type().subtype == "plain" && msg.content_type().charset == "utf-8");
}
...
{
    const string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Content-Type: text/plain; charset       =   \"UTF-8\"\r\n"
        "To: adresa@cmailio.dev\r\n"
...
BOOST_AUTO_TEST_CASE(parse_attribute_backslash_non_strict)
{
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.content_type().type == cmailio::mime::media_type_t::APPLICATION && msg.content_type().subtype == "octet-stream");
}
...
BOOST_AUTO_TEST_CASE(parse_quoted_attribute_backslash)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Content-Type: text/plain\r\n"
        "Content-Disposition: attachment; \r\n"
        "  filename=\"C:\\Windows\\cmailio.ini\"\r\n"
        "To: adresa@cmailio.dev\r\n"
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.content_type().type == cmailio::mime::media_type_t::TEXT && msg.content_type().subtype == "plain");
}
...
BOOST_AUTO_TEST_CASE(parse_continued_filename)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        ...
        "  filename*1=\"\\cmailio\\configuration.ini\"\r\n"
        "To: adresa@cmailio.dev\r\n"
        "Subject: parse address comment\r\n"
        "\r\n"
        "Hello, World!";
    ...
    msg.line_policy(codec::line_len_policy_t::RECOMMENDED, codec::line_len_policy_t::RECOMMENDED);
    msg.parse(msg_str);
    BOOST_CHECK(msg.name() == "C:\\Program Files\\AlephoLtd\\cmailio\\configuration.ini");
}
...
BOOST_AUTO_TEST_CASE(parse_multiline_header)
{
    ...
    msg.line_policy(codec::line_len_policy_t::RECOMMENDED, codec::line_len_policy_t::RECOMMENDED);
    msg.parse(msg_str);
    BOOST_CHECK(msg.message_id() == "<123456789012345678901234567890123456789012345678901234567890@cmailio.dev>");
}
...
BOOST_AUTO_TEST_CASE(parse_long_header)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Message-ID: <123456789012345678901234567890123456789012345678901234567890@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
...
BOOST_AUTO_TEST_CASE(parse_long_text_default_default)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>, <qwerty@gmail.com>\r\n"
...
BOOST_AUTO_TEST_CASE(parse_long_text_default_qp)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        ...
        "ma potrebe, jer libcmailio nije zamishljen da se\r\n"
...
BOOST_AUTO_TEST_CASE(parse_multipart_html_ascii_bit7_plain_utf8_base64)
{
    ...
    BOOST_CHECK(msg.boundary() == "my_bound" && msg.subject() == "parse multipart html ascii bit7 plain utf8 base64" && msg.date_time() == ldt &&
        msg.from_to_string() == "cmailio <adresa@cmailio.dev>" && msg.recipients().addresses.size() == 1 &&
...
BOOST_AUTO_TEST_CASE(parse_multipart_html_ascii_base64_plain_ascii_bit7)
{
    ...
    BOOST_CHECK(msg.subject() == "parse multipart html ascii base64 plain ascii bit7" &&  msg.boundary() == "my_bound" && msg.date_time() == ldt &&
        msg.from_to_string() == "cmailio <adresa@cmailio.dev>" && msg.recipients().addresses.size() == 2 &&
        msg.content_type().type == mime::media_type_t::MULTIPART && msg.content_type().subtype == "related" && msg.parts().size() == 2);
    BOOST_CHECK(msg.parts().at(0).content_type().type == mime::media_type_t::TEXT && msg.parts().at(0).content_type().subtype == "html" &&
        msg.parts().at(0).content_transfer_encoding() == mime::content_transfer_encoding_t::BASE_64 &&
...
BOOST_AUTO_TEST_CASE(parse_dotted_multipart_no_esc)
{
    ...
    string msg_str =
        "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>, Tomislav Karastojkovic <qwerty@gmail.com>, Tomislav Karastojkovic <asdfgh@zoho.com>, Tomislav Karastojkovic <zxcvbn@hotmail.com>\r\n"
        "Date: Tue, 15 Mar 2016 13:13:32 +0000\r\n"
        "MIME-Version: 1.0\r\n"
        "Content-Type: multipart/related; boundary=\"my_bound\"\r\n"
    ...
    BOOST_CHECK(msg.subject() == "parse dotted multipart no esc" && msg.boundary() == "my_bound" &&
        msg.date_time() == ldt && msg.from_to_string() == "cmailio <adresa@cmailio.dev>" && msg.recipients().addresses.size() == 4 &&
...
BOOST_AUTO_TEST_CASE(parse_multipart_content)
{
    ...
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>, <qwerty@gmail.com>, Tomislav Karastojkovic <asdfgh@outlook.com>\r\n"
        "Date: Fri, 17 Jan 2014 05:39:22 -0730\r\n"
        "MIME-Version: 1.0\r\n"
        "Content-Type: multipart/alternative; boundary=\"my_bound\"\r\n"
    ...
    BOOST_CHECK(msg.subject() == "parse multipart content" && msg.content() == "This is a multipart message." && msg.boundary() == "my_bound" &&
        msg.date_time() == ldt && msg.from_to_string() == "cmailio <adresa@cmailio.dev>" && msg.recipients().addresses.size() == 3 &&
        msg.content_type().type == mime::media_type_t::MULTIPART && msg.content_type().subtype == "alternative" && msg.parts().size() == 2);
    BOOST_CHECK(msg.parts().at(0).content_type().type == mime::media_type_t::TEXT && msg.parts().at(0).content_type().subtype == "html" &&
        msg.parts().at(0).content_transfer_encoding() == mime::content_transfer_encoding_t::BASE_64 &&
...
BOOST_AUTO_TEST_CASE(parse_multilined_addresses)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <kontakt@cmailio.dev>\r\n"
        "To: contact <kontakt@cmailio.dev>,\r\n"
        "  Tomislav Karastojkovic <adresa@cmailio.dev>,\r\n"
        "  Tomislav Karastojkovic <qwerty@gmail.com>,\r\n"
        "  Tomislav Karastojkovic <asdfg@zoho.com>,\r\n"
        "Cc: mail.io <adresa@cmailio.dev>,\r\n"
    ...
    BOOST_CHECK(msg.from().addresses.at(0).name == "cmailio" && msg.from().addresses.at(0).address == "adresa@cmailio.dev" &&
        msg.recipients().addresses.at(0).name == "contact" && msg.recipients().addresses.at(0).address == "kontakt@cmailio.dev" &&
        msg.recipients().addresses.at(1).name == "Tomislav Karastojkovic" && msg.recipients().addresses.at(1).address == "adresa@cmailio.dev" &&
        ...
        msg.cc_recipients().addresses.at(0).name == "mail.io" && msg.cc_recipients().addresses.at(0).address == "adresa@cmailio.dev" &&
...
BOOST_AUTO_TEST_CASE(parse_long_addresses)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "Reply-To: Tomislav Karastojkovic <kontakt@cmailio.dev>\r\n"
        "To: contact <kontakt@cmailio.dev>, Tomislav Karastojkovic <adresa@cmailio.dev>, Tomislav Karastojkovic <qwerty@gmail.com>, "
        "Tomislav Karastojkovic <asdfg@zoho.com>\r\n"
        "Cc: mail.io <adresa@cmailio.dev>, Tomislav Karastojkovic <zxcvb@yahoo.com>\r\n"
        "Date: Wed, 23 Aug 2017 22:16:45 +0000\r\n"
        "Subject: Hello, World!\r\n"
...
{
    string msg_str = "From: =?UTF-8?Q?=D0=BC=D0=B0=D0=B8=D0=BB=D0=B8=D0=BE?= <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>, \r\n"
        "    =?UTF-8?Q?Tomislav_Karastojkovi=C4=87?= <qwerty@gmail.com>, \r\n"
        "    =?UTF-8?Q?=D0=A2=D0=BE=D0=BC=D0=B8=D1=81=D0=BB=D0=B0=D0=B2_=D0=9A=D0=B0=D1=80=D0=B0=D1=81=D1=82=D0=BE=D1=98=D0=BA=D0=BE=D0=B2=D0=B8=D1=9B?= <asdfg@zoho.com>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.from().addresses.at(0).name == "маилио" && msg.from().addresses.at(0).address == "adresa@cmailio.dev" &&
        msg.recipients().addresses.at(0).name == "cmailio" && msg.recipients().addresses.at(0).address == "adresa@cmailio.dev" &&
...
{
    string msg_str = "From: =?UTF-8?B?0LzQsNC40LvQuNC+?= <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Subject: proba\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "\r\n"
...
{
    string msg_str = "From: =?windows-1252?Q?Action_fran=E7aise_?=<adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: examen\r\n"
        "\r\n"
    ...
    msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
    msg.parse(msg_str);
    BOOST_CHECK(msg.from().addresses.at(0).name == "Action fran" "\xE7" "aise" && msg.from().addresses.at(0).address == "adresa@cmailio.dev");
}
...
BOOST_AUTO_TEST_CASE(parse_qb_utf8_subject)
{
    ...
    msg.parse(msg_str);
    BOOST_CHECK(msg.from().addresses.at(0).name == "mail io" && msg.from().addresses.at(0).address == "adre.sa@cmailio.dev" && msg.date_time() == ldt &&
        msg.recipients_to_string() == "cmailio <adresa@cmailio.dev>" && msg.subject() == "Re: Σχετ: Summer 2017" && msg.content() == "hello world");
}


/**
Parsing a message with Q/Base64 encoded subject in the ISO-8859-1 charset by using the cmailio string type.
...
BOOST_AUTO_TEST_CASE(parse_qq_latin1_subject_raw)
{
    ...
    BOOST_CHECK(msg.from().addresses.at(0).name == "cmailio" && msg.from().addresses.at(0).address == "adresa@cmailio.dev" && msg.date_time() == ldt &&
        msg.recipients_to_string() == "cmailio <adresa@cmailio.dev>" &&
...
{
    string msg_str = "From: =??Q?=D0=BC=D0=B0=D0=B8=D0=BB=D0=B8=D0=BE?= <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: proba\r\n"
        "\r\n"
...
{
    string msg_str = "From: =?UTF-8\?\?=D0=BC=D0=B0=D0=B8=D0=BB=D0=B8=D0=BE?= <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: proba\r\n"
        "\r\n"
...
BOOST_AUTO_TEST_CASE(parse_message_id)
{
...

    {
        ...
        msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
        msg.parse(msg_str);
        BOOST_CHECK(msg.message_id() == "1234567890@cmailio.dev");
    }
    {
        // non-strict mode
        message msg;
...
BOOST_AUTO_TEST_CASE(parse_few_message_ids)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "Message-ID: <1@cmailio.dev><2@cmailio.dev>   <3@cmailio.dev>    <4@cmailio.dev>   \r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: Proba\r\n"
        "\r\n"
        "Zdravo, Svete!\r\n";
    {
        ...
        msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
        msg.parse(msg_str);
        BOOST_CHECK(msg.message_id() == "1@cmailio.dev");
    }
    {
        message msg;
        msg.strict_mode(false);
        msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
        msg.parse(msg_str);
        BOOST_CHECK(msg.message_id() == "<1@cmailio.dev><2@cmailio.dev>   <3@cmailio.dev>    <4@cmailio.dev>");
    }
}
...
BOOST_AUTO_TEST_CASE(parse_in_reply_to)
{
        ...
        "Zdravo, Svete!\r\n";
    {
        ...
        msg.strict_mode(true);
        msg.parse(msg_str);
        BOOST_CHECK(msg.in_reply_to().size() == 3 && msg.in_reply_to().at(0) == "1@cmailio.dev" && msg.in_reply_to().at(1) == "22@cmailio.dev" &&
            msg.in_reply_to().at(2) == "333@cmailio.dev" && msg.references().at(0) == "4444@cmailio.dev" && msg.references().at(1) == "55555@cmailio.dev");
    }
    {
        message msg;
        msg.strict_mode(false);
        ...
        BOOST_CHECK(msg.in_reply_to().size() == 1 && msg.in_reply_to().at(0) == "<1@cmailio.dev> <22@cmailio.dev> <333@cmailio.dev>" &&
            msg.references().size() == 1 && msg.references().at(0) == "<4444@cmailio.dev> <55555@cmailio.dev>");
    }
}
...
BOOST_AUTO_TEST_CASE(parse_in_reply_without_monkey)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "In-reply-To: <1@cmailio.dev> <2 cmailio.dev>\r\n"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: Proba\r\n"
        "\r\n"
        "Zdravo, Svete!\r\n";
    ...
    }
    {
        ...
        msg.line_policy(codec::line_len_policy_t::MANDATORY, codec::line_len_policy_t::MANDATORY);
        msg.parse(msg_str);
        BOOST_CHECK(msg.in_reply_to().size() == 1 && msg.in_reply_to().at(0) == "<1@cmailio.dev> <2 cmailio.dev>");
    }
}
...
BOOST_AUTO_TEST_CASE(parse_references_without_brackets)
{
    string msg_str = "From: cmailio <adresa@cmailio.dev>\r\n"
        "To: cmailio <adresa@cmailio.dev>\r\n"
        "References: <1@cmailio.dev> 2@cmailio.dev\r\n"
        "In-reply-To: <3@cmailio.dev> <4@cmailio.dev>"
        "Date: Thu, 11 Feb 2016 22:56:22 +0000\r\n"
        "Subject: Proba\r\n"
        "\r\n"
        "Zdravo, Svete!\r\n";
...
{
    message msg1;
    msg1.from(mail_address("cmailio", "adresa@cmailio.dev"));
    msg1.reply_address(mail_address("Tomislav Karastojkovic", "kontakt@cmailio.dev"));
    msg1.add_recipient(mail_address("kontakt", "kontakt@cmailio.dev"));
    msg1.add_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    msg1.add_recipient(mail_group("all", {mail_address("Tomislav", "qwerty@hotmail.com")}));
    msg1.add_cc_recipient(mail_group("cmailio", {mail_address("", "karas@cmailio.dev"), mail_address("Tomislav Karastojkovic", "kontakt@cmailio.dev")}));
    msg1.add_cc_recipient(mail_address("Tomislav Karastojkovic", "kontakt@cmailio.dev"));
    msg1.add_cc_recipient(mail_address("Tomislav @ Karastojkovic", "asdfg@gmail.com"));
    msg1.add_cc_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
    ...
    msg1.add_bcc_recipient(mail_address("Tomislav Karastojkovic", "kontakt@cmailio.dev"));
    msg1.add_bcc_recipient(mail_address("Tomislav @ Karastojkovic", "asdfg@gmail.com"));
    msg1.add_bcc_recipient(mail_address("cmailio", "adresa@cmailio.dev"));
